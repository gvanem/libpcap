...
#define __FILE()  "WinPcap-plugin/USB-pcap/enum.c"
...
static void wide_print (LPCWSTR string)
{
    HANDLE std_out;
    BOOL console_output;
    DWORD type;
...
static VOID PrintDeviceDesc (PCTSTR DriverName, ULONG Index,
                             ULONG Level, BOOL PrintAllChildren)
{
    DEVINST    devInst;
    DEVINST    devInstNext;
    CONFIGRET  cr;
